                    ...
                    <div class="card-body">
                      ...
                      <form method="POST" action="{{route('poststore')}}" class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input name="title" type="text" class="form-control" id="exampleInputName1" placeholder="Başlık">
                        </div>
                        <div class="form-group">
                          <label for="exampleTextarea1">İçerik</label>
                          <textarea name="body" class="form-control" name="editor" id="editor" id="body" rows="6"></textarea>
